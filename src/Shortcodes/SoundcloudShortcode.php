...
class SoundcloudShortcode extends ViewableData
{
    private static $shortcode = 'soundcloud';
    private static $singular_name = 'Soundcloud';
    private static $plural_name = 'Soundcloud';
    ...
    public static function parse_shortcode($arguments, $content, $parser, $shortcode)
    {
        ...
        return $data->renderWith('Northwestern\Now\Shortcodes\SoundcloudShortcode');
    }
    ...
    public function getShortcodeFields()
    {
        $fields = FieldList::create(
            LabelField::create('intro', 'After choosing this option, insert Soundcloud iframe in between [soundcloud] tags in source view'),
        );
